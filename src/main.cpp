...
int main(const int parc, const char** pars)
{
    ...
    /*
        ...
        Iban iban_mt_2("MT", string("MMEB"), string("44392"), string("39011176002"), true);
        std::cout << "IBAN: " << iban_mt_2 << std::endl;
    */

    Iban iban_rs_2("RS", string("205-7054947000-77"), true);
    std::cout << "IBAN: " << iban_rs_2 << std::endl;

    Iban iban_si_2("SI", string("1910 0001 0000 463"), true);
    std::cout << "IBAN: " << iban_si_2 << std::endl;

    Iban iban_se_4("SE", string("6462 495 824 291"), true);
    std::cout << "IBAN: " << iban_se_4 << std::endl;
