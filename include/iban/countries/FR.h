...
class BBan_handler_FR : public BBan_handler
{
    public:
    BBan_handler_FR(std::string const& country);
    ...
    std::string to_numeric(std::string const& bban) const;
    int bignum_mod97(std::string const& number) const;
};
